	...
	<div id="services-section" class="text-center">
		<div class="container">
			<div class="section-title center">
				...
				<p>Ce site met à disposition un accès aux comp�tences de notre
			...
			<div class="row">
				...
				<div class="col-md-4 col-sm-6 service">
					...
					<h4>D�veloppement Logiciel</h4>
					<p>JAVA, Python,...</p>
				</div>
				<div class="col-md-4 col-sm-6 service">
					<i class="fa fa-rocket"></i>
					<h4>Veille Technologique</h4>
					<p>Mat�riel, Logiciel, S�curit�,... .</p>
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container">
			<div class="section-title text-center center">
				...
				<p>
					...
					(Syst�mes Informatiques aux Organisations) option SLAM (Solutions
					Logicielles et Applications M�tiers).<br> Cette formation nous
					est dispens�e par <a
						href="http://greta-bretagne.ac-rennes.fr/portail/web/greta-de-bretagne-sud/vannes"
						target="_blank">le GRETA</a> sur une dur�e d'un an.<br> Ce
					dipl�me forme des techniciens capables de g�rer un parc
					informatique ou d'administrer un r�seau. Leur mission consiste �
					automatiser et rationnaliser les activit�s de l'entreprise. Cette
					formation nous permettra d'entrer dans le monde professionnel comme
					par exemple: d�veloppeur-euse d'applications mobiles,
					d�veloppeur-euse informatique, int�grateur-euse web, technicien-ne
				...
				<div class="col-md-6">
					<div class="about-text">
						...
						<p>
							...
							ordinateurs<br> Notions de base r�seau<br> Exploitation
							de donn�es<br> Bases de la programmation<br> Support
							des services et des serveurs<br> D�veloppement
							d'applications<br> Int�gration et adaptation d'un service<br>
							<br> Solutions logicielles et applications m�tiers (SLAM)<br>
							<br> conception, modification et g�n�ration de bases de
							donn�es<br> Programmation orient�e objet<br>
							D�veloppement d'applications pour Base de Donn�es<br>
							R�alisation de maintenance de composants logiciels<br>
							Conception et adaptation de solutions applicatives<br> <br>
							Culture g�n�rale et expression<br> Anglais<br>
							Math�matiques pour l'informatique<br> Analyse �conomique,
							manag�riale et juridique des services informatiques<br>
							Projets personnalis�s encadr�s, bas�s sur une p�dagogie de projet
							et d'apprentissage par probl�mes. Les projets sont transversaux
							et mobilisent l'ensemble des savoirs et comp�tences acquis et en
							cours d'acquisition dans les modules de formation et inversement
							permettent des rem�diations.
						</p>
		...
		<div class="container">
			<div class="section-title center">
				...
				<p>Voici notre équipe qui a construit ce site, nous venons tous
					d'horizons diff�rents mais nous avons tous une passion commune !
					L'informatique !</p>
			</div>
			<div id="row">
